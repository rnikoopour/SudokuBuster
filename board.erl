-module(board).
-compile(export_all).
-export([start_link/0, start_link/1, stop/1, set_board/2, get_board/1, is_valid_board/1]).
-export([init/1, code_change/3, handle_call/3, handle_cast/2, handle_info/2, terminate/2]).
-behaviour(gen_server).

-define(SUBBOARD, [TopLeft, TopMiddle, TopRight, MiddleLeft, MiddleMiddle, MiddleRight, BottomLeft, BottomMiddle, BottomRight]).
